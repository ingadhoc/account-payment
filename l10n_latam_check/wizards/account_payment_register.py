...
class AccountPaymentRegister(models.TransientModel):
    ...
    l10n_latam_check_bank_id = fields.Many2one('res.bank', compute='_compute_third_check_data', store=True, readonly=False)
    l10n_latam_check_issuer_vat = fields.Char(store=True, compute='_compute_third_check_data', readonly=False)
    ...
    def _create_payment_vals_from_wizard(self):
        ...
        if self.l10n_latam_checkbook_id:
            vals.update({
