...
class AccountPaymentRegister(models.TransientModel):
    ...
    def _compute_l10n_latam_checkbook(self):
        ...
        for rec in with_checkbooks:
            checkbook = rec.journal_id.with_context(
                active_test=True
            ).l10n_latam_checkbook_ids
    ...
    def _compute_l10n_latam_check_number(self):
        for rec in self.filtered("l10n_latam_checkbook_id"):
            rec.l10n_latam_check_number = (
                rec.l10n_latam_checkbook_id.sequence_id.get_next_char(
    ...
    def _compute_l10n_latam_check_data(self):
        ...
        for rec in new_third_party_checks:
            rec.update(
                {
                    "l10n_latam_check_bank_id": rec.partner_id.bank_ids
                    and rec.partner_id.bank_ids[0].bank_id
                    or False,
